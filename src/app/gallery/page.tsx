...
export const metadata = {
  title: "Smile Gallery & Clinical Case Results | DIGISMILE Dental Clinic Puducherry",
  description: "Interactive before and after smile comparison slider. See real clinical restorations, root canals, and cosmetic bonding by Dr. Sandhosh and Dr. Sandhosh in Puducherry.",
};
...
export default function GalleryPage() {
  const cases = [
    {
      ...
      description: "Patient presented with prominent gap between upper central incisors and tooth discoloration. Dr. Sandhosh completed direct layer-by-layer nano-hybrid composite bonding in a single sitting without removing any healthy tooth structure.",
      duration: "Single Sitting (60 Mins)",
      doctor: "Dr. Sandhosh (Chief Aesthetic Dentist)",
    ...
    },
    {
      ...
      description: "Severe infection in lower left first molar causing sleepless nights. Dr. Sandhosh carried out single-sitting rotary root canal therapy followed by high-precision CAD/CAM zirconia crown placement, restoring full chewing capability.",
      duration: "Single-Sitting RCT + Crown Fitting",
      doctor: "Dr. Sandhosh (Lead Endodontist)",
  ...
  return (
    <div className="bg-white pb-24 font-sans text-gray-900">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-12">
        <div className="max-w-3xl space-y-6">
          ...
          <p className="text-lg font-medium text-gray-500 leading-relaxed">
            Real patient outcomes from our Lenin St operatory in Heritage Town. Use the interactive comparison sliders below to inspect the precision of Dr. Sandhosh and Dr. Sandhosh&apos;s restorative and aesthetic treatments.
          </p>
        </div>
      </div>
      ...
      {/* WHY CHOOSE DIGISMILE FOR COSMETIC & RESTORATIVE EXCELLENCE */}
        ...
        <div className="bg-gray-900 text-white rounded-[2rem] p-8 sm:p-14 shadow-lg relative overflow-hidden">
          ...
          <div className="max-w-3xl space-y-6 relative z-10">
            ...
            <p className="text-lg font-medium text-gray-300 leading-relaxed max-w-2xl">
              Many clinics produce crowns or veneers that look unnaturally flat and opaque white. Dr. Sandhosh custom shades every restoration to mimic natural enamel light reflection, subtle surface mamelons, and proper gum contours.
            </p>
